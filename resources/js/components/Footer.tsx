    ...
    <footer id="contact" className="border-t-4 border-t-turquoise/70 bg-[#061a31] text-navy-foreground">
      ...
      <div className="border-t border-navy-foreground/15">
        <div className="container-page flex flex-col gap-3 py-5 text-xs text-navy-foreground/65 sm:flex-row sm:items-center sm:justify-between">
          <p>© 2026 Easy Blue Divers Zanzibar. All Rights Reserved.</p>
          <div className="flex flex-wrap gap-x-4 gap-y-2"><Link href="/booking-terms" className="hover:text-navy-foreground">Booking Terms</Link><Link href="/privacy" className="hover:text-navy-foreground">Privacy</Link><a href={adminHref} aria-label={`Open ${adminLabel}`} className="inline-flex items-center gap-1 hover:text-turquoise"><LockKeyhole className="size-3" aria-hidden="true" />{adminLabel}</a></div>
        </div>
      </div>
    </footer>
  );
