...
export function AdminAddPanel({ title, description, children }: { title: string; description: string; children: ReactNode }) {
  return <details className="group rounded-3xl border border-border bg-card shadow-sm open:shadow-md">
